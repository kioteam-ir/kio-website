...
export function Projects() {
  return (
    <Container as="section" id="projects" dir="rtl" className="py-20">
      <SectionHeading index="03" eyebrow="نمونه‌کار" title="کارهایی که ساخته‌ایم" />
        ...
        {PROJECTS.map((project) => (
          ...
          >
            ...
            <div className="flex flex-1 flex-col p-6">
              <span className="mb-2 w-fit rounded border border-slate-800 px-2 py-0.5 font-mono text-[11px] text-slate-500">{project.tag}</span>
              ...
              <a
                ...
                className="grad-brand-text text-center font-mono text-xs font-bold uppercase tracking-widest transition-transform hover:scale-105"
              >
                {"< "}مشاهده زنده{" >"}
              </a>
            </div>
