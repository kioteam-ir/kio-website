  ...
  const cards = [
      ...
      icon: (
        ...
        >
          <g clip-path="url(#clip0_5_228)">
            <path
              d="M20 0C20 0 19.166 17.324 0 20C0 20 16.453 20.315 20 40C20 40 21.13 22.982 40 20C40 20 22.07 17.477 20 0Z"
              fill="#8C77EC"
            />
          </g>
          <defs>
    ...
    },
    {
      icon: (
        ...
        >
          <path
            d="M19.739 0C25.1126 0 30.266 2.13463 34.0657 5.93431C37.8654 9.73398 40 14.8874 40 20.261V24.141H0V19.739C0 14.5039 2.07964 9.4832 5.78142 5.78142C9.4832 2.07964 14.5039 0 19.739 0V0Z"
            fill="#00ADB5"
          />
        </svg>
      ),
