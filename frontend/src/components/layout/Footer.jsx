        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr]">
          ...
          <div className="space-y-5">
            ...
            <p className="max-w-sm text-sm leading-7 text-slate-400">
              ...
              محصولات دیجیتال را با دقت یک نقشهٔ مهندسی می‌سازیم.
            </p>
            <div>
          ...
          {/* Sitemap */}
          <div>
            <h3 className="mb-5 font-mono text-xs uppercase tracking-widest text-amber-400/80">نقشه سایت</h3>
          ...
          {/* Services */}
          <div>
            <h3 className="mb-5 font-mono text-xs uppercase tracking-widest text-amber-400/80">خدمات</h3>
            <ul className="space-y-3 text-sm">
          ...
          {/* Contact */}
          <div>
            <h3 className="mb-5 font-mono text-xs uppercase tracking-widest text-amber-400/80">راه‌های ارتباطی</h3>
            <ul className="space-y-4 text-sm text-slate-400">
              <li className="flex items-start gap-2.5">
                <IconMapPin className="mt-0.5 h-4 w-4 shrink-0 text-amber-400/80" />
                <span>ایران — کرمانشاه</span>
              </li>
              <li className="flex items-start gap-2.5">
                <IconPhone className="mt-0.5 h-4 w-4 shrink-0 text-amber-400/80" />
                <span dir="ltr" className="text-end">+98 912 000 0000</span>
              </li>
              <li className="flex items-start gap-2.5">
                <IconEmail className="mt-0.5 h-4 w-4 shrink-0 text-amber-400/80" />
            ...
            <div className="mt-5 flex gap-3">
              {SOCIAL_LINKS.map((link) => (
                <a
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-md border border-slate-800 text-slate-400 transition-colors hover:border-amber-400/40 hover:text-amber-300"
                >
        ...
        <div className="mt-14 flex flex-col items-center gap-4 border-t border-slate-800 pt-6 sm:flex-row sm:justify-between">
          ...
          <div className="flex gap-6 text-xs text-slate-500">
            {LEGAL_LINKS.map((link) => (
              <a key={link.label} href={link.href} className="hover:text-amber-300">
                {link.label}
              </a>
            ))}
          </div>
