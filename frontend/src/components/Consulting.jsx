...
//   return (
//       <div className="2xl:max-w-7xl xl:max-w-6xl lg:max-w-4xl md:max-w-2xl sm:max-w-xl max-w-lg mx-auto sm:px-0 px-2 mt-20">
...
//           {/* متن مرکزی */}
//           <div className="lg:col-span-1 text-center space-y-8 lg:space-y-10">
...
//               <a
//                 href="#contact"
//                 className="inline-block px-10 py-5 text-xl font-semibold text-white bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 rounded-full shadow-lg hover:shadow-purple-500/30 transition-all duration-300 transform hover:scale-105"
//               >
//                 Contact us
//               </a>
//             </div>
...
//         {/* نسخه موبایل - عکس‌ها بالا و پایین */}
