...
export function IconRefresh({ className = base }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M4 4v5h.58M20 20v-5h-.58M4.6 9A8 8 0 0 1 19.4 9M19.4 15a8 8 0 0 1-14.8 0" />
    </svg>
  );
}
...
export function IconLogout({ className = base }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M17 16l4-4-4-4M21 12H9M13 4H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h6" />
    </svg>
  );
}
...
export function IconPhone({ className = base }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M4 5c0 8.28 6.72 15 15 15l2-4-5-3-2 2c-2.5-1.2-4.8-3.5-6-6l2-2-3-5-4 2" />
    </svg>
  );
}
...
export function IconShield({ className = base }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} className={className}>
      <path strokeLinejoin="round" d="M12 3c2.6 1.6 5 2 8 2v6c0 5-3.2 8.4-8 10-4.8-1.6-8-5-8-10V5c3 0 5.4-.4 8-2Z" />
    </svg>
  );
}
