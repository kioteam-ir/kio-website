  ...
  return (
      <section class="min-h-screen bg-gray-900">
          <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
              <div class="mx-auto max-w-screen-sm flex flex-col items-center justify-center text-center">
                  ...
                  <Link to="/" class="inline-flex text-white hover:underline bg-primary-600 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-2xl px-5 text-center dark:focus:ring-primary-900">Back to Homepage</Link>
              </div>   
          </div>
      </section>
  )
